                        ...
                        <View style={styles.chartBlock}>
                            ...
                            <View style={styles.legends}>
                                <View style={styles.legends_legend}>
                                    <FontAwesome style={styles.greenCircle} name='circle' />
                                    <Text style={styles.greenText}>Qualité du sommeil</Text>
                                </View>
                                <View style={styles.legends_legend}>
                                    <FontAwesome style={styles.purpleCircle} name='circle' />
                                    <Text style={styles.purpleText}>Humeur au réveil</Text>
                                </View>
                            </View>
